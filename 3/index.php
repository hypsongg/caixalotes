<html lang="pt-br"><head>
    ...
    <script>
  window.pixelId = "675787b3809ef971b27e2939";
    ...
    <div class="container-bg">
        ...
        <div class="container-principal d-flex flex-column justify-content-center align-items-center flex-column">
            ...
            <div class="container-principal-p">
                <h1>R$ 600.000.000,00</h1>
                <h2>Bolão Especial</h2>
                <div class="line"></div>
                <h2>Sorteio: <b>31/12/2024</b></h2>
                <h2>Composição: <b>1 Bolão com 09 Dezenas</b></h2>
                <div class="line"></div>
                <div class="dezenas">
                    <span>01</span>
                    <span>02</span>
                ...
                <div class="line"></div>
                <h3>Sua chance de ganhar aumenta em 5x (vezes)!</h3>
                <div class="line"></div>
                <h2>Disponíveis: <b>11 Cotas</b></h2>
                <h2>Valor da Cota: <b>R$29,90</b></h2>
                <div class="botoes">
                    <a href="https://pay.loteriascaixabrasil.com/meABG9y1p8DG6Ea"><button><i class="bi bi-cart-fill"></i> GARANTIR</button></a>
                </div>
            </div>
        </div>
        -->
        ...
        <div class="container-principal d-flex flex-column justify-content-center align-items-center flex-column">
            ...
            <div class="container-principal-p">
                ...
                <div class="botoes">
                    <a href="https://pay.checkoutpagamentos.top/q510ZORBvKK3E9D"><button><i class="bi bi-cart-fill"></i> GARANTIR</button></a>
                </div>
            </div>
        </div>
        ...
        <div class="container-principal d-flex flex-column justify-content-center align-items-center flex-column">
            ...
            <div class="container-principal-p">
                ...
                <div class="botoes">
                    <a href="https://pay.checkoutpagamentos.top/YEwR3A9weKd3dKy"><button><i class="bi bi-cart-fill"></i> GARANTIR</button></a>
                </div>
            </div>
        </div>
        ...
        <div class="container-destaque">
            ...
            <div class="container-principal d-flex flex-column justify-content-center align-items-center flex-column">
                ...
                <div class="container-principal-p">
                    ...
                    <div class="botoes">
                        <a href="https://pay.checkoutpagamentos.top/VroegNjyvKzgKwj"><button style="background-color: #0070ae;"><i class="bi bi-cart-fill"></i> GARANTIR</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-principal d-flex flex-column justify-content-center align-items-center flex-column">
            ...
            <div class="container-principal-p">
                ...
                <div class="line"></div>
                <h3>Sua chance de ganhar aumenta em 100x (vezes)!</h3>
                <div class="line"></div>
                <h2>Disponíveis: <b>00 Cotas</b></h2>
                <h2>Valor da Cota: <b>R$109,90</b></h2>
                <div class="botoes">
                    <button class="btn-nao"><i class="bi bi-cart-fill"></i> ESGOTADO</button>
                </div>
            </div>
        </div>
